...
#[test]
fn quarry_mako_attribution_admission_ab_is_path_quiet() {
    let root = std::env::temp_dir().join(format!(
        "cultist-quarry-mako-attribution-admission-root-{}",
        std::process::id()
    ));
    let inventory_path = std::env::temp_dir().join(format!(
        "cultist-quarry-mako-attribution-admission-inventory-{}.json",
        std::process::id()
    ));
    ...
    let inventory = r#"{
  "schema_version": 1,
  "source": "github:bounded-performance-family-mako-2026-08-22T20:58:00Z",
  "observed_at": "2026-08-22T20:58:00Z",
  "current": {
    "id": "mako/attribution-admission-ab",
    "kind": "planned_work",
    "title": "Mako measure typed replay-parent admission equality",
    "url": "https://github.com/Coreys-Quarry/quarry/issues/563",
    "head_ref": "main",
    "head_sha": "cee305cfe7af6603fada628f0acfbc151889980d",
    "updated_at": "2026-08-22T20:58:00Z",
    "draft": false,
    "activity": "preparation",
    "changed_paths": [
      ".github/workflows/research-563-attribution-admission-ab.yml",
      "scripts/research_563_attribution_admission_ab.py",
  ...
  "coordination_edges": []
    ...
    assert!(
        overlaps.is_empty(),
        "attribution admission A/B unexpectedly overlaps active work: {stdout}"
    );
